...
const TopBar = () => (
    <div className="w-full p-4 bg-white rounded-xl h-16 flex justify-between items-center">
        <div className="flex gap-2 items-center text-primary">
            ...
            <span className="font-semibold text-xl text-gray-800">News</span>
        </div>
        <div className="flex gap-4 items-center">
            <button type="button" className="hover:text-primary">
                <svg className="w-6" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M20.0264 25.4131C20.0264 27.6131 18.2264 29.4131 16.0264 29.4131C14.933 29.4131 13.9197 28.9598 13.1997 28.2398C12.4797 27.5198 12.0264 26.5064 12.0264 25.4131" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" />
