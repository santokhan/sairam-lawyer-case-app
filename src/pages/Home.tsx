        ...
        <div className="flex justify-start mt-4">
            <button type="button"
                ...
                <svg className="w-4" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_1256_20849)">
                        ...
                        <path d="M5.43311 8.00003C6.54211 7.4459 7.44591 6.54211 7.99999 5.43311C8.55411 6.54211 9.45786 7.4459 10.5669 8.00003C9.45786 8.55411 8.55411 9.4579 7.99999 10.5669C7.44591 9.4579 6.54211 8.55411 5.43311 8.00003Z" fill="#020202" />
                    </g>
                    <defs>
...
const HomePage = () => {
    return (
        <div className="bg-[#F0F5FF] py-2">
            <AppContainer>
                <div className={"w-full grid sm:grid-cols-2 lg:grid-cols-4 gap-6 py-4"}>
                    {gridArray.map((e, i) => (
                        <Link to={e.path} className={[
                            "bg-white p-10 rounded-xl space-y-6 hover:border-primary hover:shadow-xl hover:scale-105",
                            "transition-transform ease-out", i === 0 || i === 1 ? 'col-span-2' : ''
                        ].join(" ")} key={i}>
                            {e.icon}
                            <h4 className="text-2xl font-semibold urbanist text-gray-700">{e.name}</h4>
                            <p className="py-4"></p>
                        </Link>
                    ))}
                    <LastItem />
