                ...
                {connectionList.map((e, i) =>
                    <li className="flex justify-between items-center">
                        <figure className="flex gap-3 items-center">
                            <img src="https://i.pravatar.cc/200" alt="profile" className="w-12 h-12 rounded-full" />
                            <article className="">
                        ...
                        <li className="border rounded-xl p-4 space-y-4" key={i}>
                            <div className="flex justify-between items-start gap-3">
                                <div className="flex gap-3 items-center">
                                    <img src="https://i.pravatar.cc/200" alt="profile" className="min-w-[4.5rem] w-[4.5rem] min-h-[4.5rem] h-[4.5rem] rounded-full" />
                                </div>
